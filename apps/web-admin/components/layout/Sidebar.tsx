    ...
    return (
        <div className="w-64 bg-gradient-to-b from-purple-800 to-purple-700 text-white flex flex-col justify-between">
                    ...
                    {menu.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center gap-3 w-full px-4 py-2.5 rounded-lg text-sm transition ${isActive
            ...
            <div className="p-4 border-t border-purple-600">
                ...
                <button onClick={handleLogout} className="mt-3 text-red-300 hover:text-red-400 text-sm">
                    Logout
                </button>
            </div>
        </div>
